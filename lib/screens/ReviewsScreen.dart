...
const String _ronaldRichardsAvatar =
    'https://example.com/avatar_ronald_richards.jpg';
const String _guyHawkinsAvatar = 'https://example.com/avatar_guy_hawkins.jpg';
const String _savannahNguyenAvatar =
    'https://example.com/avatar_savannah_nguyen.jpg';
                    ...
                    Row(
                      children: [
                        ...
                        ...List.generate(
                          ...
                          (index) => Icon(
                            index <
                                    4 // Assuming 4 full stars for 4.8, then a half
                                ? Icons.star
                                : (index == 4
                                      ? Icons.star_half
                                      : Icons.star_border),
                                ...
                                (index) => Icon(
                                  index < review.rating.floor()
                                      ...
                                      : (index == review.rating.floor() &&
                                                review.rating % 1 != 0
                                            ? Icons
                                                  .star_half // For half stars like 4.5
                                            : Icons.star_border),
                                  color: Colors.amber,
                                  size: 14,
                                ),
